...
import { ArrowRight, CheckCircle2, Truck, MapPin, Store, Quote } from 'lucide-react';
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              <FadeInSection direction="left">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black leading-tight mb-6">
                  Road Traffic Data <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38e54d] to-[#8eea9e]">Intelligence</span>
                </h1>
            ...
            <div className="lg:w-1/2 relative w-full max-w-lg mx-auto">
              <FadeInSection direction="right" delay={200}>
                <div className="relative">
                  ...
                  <img 
                    src="https://www.s-locator.com/wp-content/uploads/2024/11/png-16.png" 
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <Truck size={32} />, title: "Logistics", desc: "Optimize delivery routes and reduce transportation costs." },
              { icon: <MapPin size={32} />, title: "Urban Planning", desc: "Plan infrastructure projects like new roads or public transport routes." },
              { icon: <Store size={32} />, title: "Retail", desc: "Select store locations with high visibility and accessibility." }
            ].map((useCase, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/png-14.png" 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Supply Chain Optimization</h2>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="right">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/png-15.png" 
                  alt="Urban Planning" 
                  className="w-full max-w-[500px] mx-auto drop-shadow-2xl hover:scale-105 transition-transform duration-700" 
                />
              </FadeInSection>
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="left">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Urban Planning</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Retail Site Selection</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
