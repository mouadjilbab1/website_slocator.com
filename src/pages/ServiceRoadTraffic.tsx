    ...
    useCasesList: [
      {
        ...
        desc: isAr ? "تحسين مسارات التوصيل وتقليل تكاليف النقل والوقود." : "Optimize delivery routes and reduce transportation costs."
      },
      {
        icon: <MapPin size={32} />,
        title: isAr ? "التخطيط الحضري" : "Urban Planning",
        desc: isAr ? "تخطيط مشاريع البنية التحتية مثل الطرق الجديدة أو مسارات النقل العام." : "Plan infrastructure projects like new roads or public transport routes."
      },
      {
        icon: <Store size={32} />,
        title: isAr ? "التجزئة" : "Retail",
        desc: isAr ? "اختيار مواقع المتاجر ذات الرؤية الواضحة وسهولة الوصول للعملاء." : "Select store locations with high visibility and accessibility."
      }
    ],

    detTitle1: isAr ? 'تحسين سلسلة الإمداد' : 'Supply Chain Optimization',
    detDesc1: isAr ? 'تقوم شركات الخدمات اللوجستية بتحليل أنماط حركة المرور لتخطيط مسارات التوصيل الأكثر كفاءة، مما يقلل من تكاليف الوقود وأوقات التسليم.' : 'Logistics companies analyze traffic patterns to plan the most efficient delivery routes, reducing fuel costs and delivery times.',
    
    detTitle2: isAr ? 'التخطيط الحضري' : 'Urban Planning',
    detDesc2: isAr ? 'يستخدم مخططو المدن بيانات حركة المرور لتحديد النقاط الساخنة للازدحام وتصميم تحسينات البنية التحتية، مثل الطرق الجديدة أو تحسين إشارات المرور.' : 'City planners use traffic data to identify congestion hotspots and design infrastructure improvements, such as new roads or traffic signal optimizations.',
    
    detTitle3: isAr ? 'اختيار مواقع التجزئة' : 'Retail Site Selection',
    detDesc3: isAr ? 'تستخدم شركة تتطلع لفتح متجر جديد بيانات حركة المرور لاختيار موقع يتميز بحركة مرور عالية للمركبات أو المشاة لزيادة الرؤية والإقبال.' : 'A business looking to open a new store uses traffic data to choose a location with high vehicle or pedestrian traffic to maximize visibility and footfall.',
