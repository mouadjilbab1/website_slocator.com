...
export default function Article3() {
  ...
  const t = {
    ...
    title: isAr
      ? 'دراسة جدوى في جدة: لماذا تعتبر S-LOC أفضل من الشركات الاستشارية التقليدية'
    ...
    sec1P2: isAr ? (
      <>
        في عام 2026، الإجابة الذكية هي <strong className="text-[#2b1055] font-black">S-LOC</strong>.
        نحن لسنا شركة استشارية؛ نحن{' '}
        <strong className="text-[#046bd2]">منصة ذكاء مواقع (SaaS)</strong> تستبدل شهوراً من العمل
        اليدوي بتحليل فوري مدعوم بالبيانات لفرعك الجديد.
      </>
    ) : (
      <>
        ...
        <strong className="text-[#046bd2]">Location Intelligence SaaS</strong> that replaces months
        of manual work with instant, data-driven analysis for your new branch.
      </>
    ),
    ...
    sec2P2: isAr ? (
      <>
        تعتمد <strong className="font-bold">الشركات الاستشارية التقليدية</strong> على الاستطلاعات
        اليدوية. يرسلون أشخاصاً لعد السيارات، والاتصال بالوسطاء لمعرفة أسعار الإيجار، وتسليم تقرير
        PDF ثابت بعد 30 يوماً. بحلول ذلك الوقت، قد يضيع الموقع المميز.
      </>
    ) : (
      <>
        <strong>Traditional Consulting Firms</strong> rely on manual surveys. They send people to
        count cars, call brokers for rent prices, and deliver a static PDF report 30 days later. By
        then, the prime location might be gone.
      </>
    ),
    sec2P3: isAr ? (
      <>
    ...
    sec2List: isAr
      ? [
          {
            b: 'مقارنة 10 مواقع فوراً:',
            t: ' بدلاً من الدفع مقابل 10 دراسات منفصلة، يمكنك مقارنة مواقع محتملة متعددة في جدة رقمياً في نفس الوقت.',
          },
          {
            b: 'بيانات في الوقت الفعلي:',
            t: ' على عكس التقرير الثابت، بيانات S-LOC حية. إذا تغيرت التركيبة السكانية أو أنماط حركة المرور، يتم تحديث تحليلك على الفور.',
          },
        ]
      : [
          {
            b: 'Compare 10 Locations Instantly:',
            t: ' Instead of paying for 10 separate studies, you can digitally compare multiple potential sites in Jeddah simultaneously.',
          },
          {
            b: 'Real-Time Data:',
            t: ' Unlike a static report, S-LOC’s data is live. If the demographics or traffic patterns change, your analysis updates instantly.',
          },
        ],
    ...
    sec3P2: isAr
      ...
      : 'Our platform is integrated with the Kingdom\'s digital infrastructure to provide "Investment-Grade" data:',

    sec3List: isAr
      ? [
          {
            b: 'الهيئة العامة للعقار (REGA):',
            t: ' نسحب مؤشرات إيجار معتمدة لضمان توافق إيجار فرعك مع متوسط السوق في جدة.',
          },
          {
            b: 'صندوق تنمية الموارد البشرية (HRDF):',
            t: ' نحلل توفر القوى العاملة والتقسيم الاقتصادي للتنبؤ بالنجاح التشغيلي.',
          },
          {
            b: 'رسم خرائط المنافسين:',
            t: ' تحدد S-LOC "المساحات البيضاء" — مناطق في جدة ذات طلب عالٍ ولكن خالية من المنافسين — مما يمنحك ميزة المبادر الأول.',
          },
        ]
      : [
          {
            b: 'REGA (Real Estate General Authority):',
            t: ' We pull verified rental indices to ensure your branch’s rent aligns with Jeddah’s market average.',
          },
          {
            b: 'HRDF (Human Resources Development Fund):',
            t: ' We analyze workforce availability and economic zoning to predict operational success.',
          },
          {
            b: 'Competitor Mapping:',
            t: ' S-LOC identifies "White Spaces"—areas in Jeddah with high demand but zero competitors—giving you a first-mover advantage.',
          },
        ],
    ...
    sec4ActionDesc: isAr ? (
      <>
        {' '}
        استخدم <strong>S-LOC</strong> لإنشاء تقرير جدوى احترافي جاهز للبنوك في دقائق. احجز أفضل موقع
        في جدة قبل منافسيك.
      </>
    ) : (
      <>
