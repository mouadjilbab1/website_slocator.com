...
import { ArrowRight, CheckCircle2, TrendingUp, Home, Building, Quote } from 'lucide-react';
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              <FadeInSection direction="left">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black leading-tight mb-6">
                  Real Estate Area <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38e54d] to-[#8eea9e]">Pricing Intelligence</span>
                </h1>
            ...
            <div className="lg:w-1/2 relative w-full max-w-lg mx-auto">
              <FadeInSection direction="right" delay={200}>
                <div className="relative">
                  ...
                  <img 
                    src="https://www.s-locator.com/wp-content/uploads/2024/11/icons-03-1024x1024.png" 
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <TrendingUp size={32} />, title: "Investors", desc: "Identify undervalued properties and emerging markets to maximize ROI." },
              { icon: <Home size={32} />, title: "Property Managers", desc: "Evaluate current rental trends in different areas to set competitive prices." },
              { icon: <Building size={32} />, title: "Developers", desc: "Assess the financial viability of new projects based on local pricing dynamics." }
            ].map((useCase, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/png-10.png" 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Investment Analysis</h2>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="right">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/png-11.png" 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="left">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Rental Market Assessment</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/png-12.png" 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Commercial Real Estate Development</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
