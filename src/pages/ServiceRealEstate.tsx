...
import { ArrowRight, ArrowLeft, CheckCircle2, TrendingUp, Home, Building, Quote } from 'lucide-react';
...
export default function ServiceRealEstate() {
  ...
  const t = {
    ...
    titlePart1: isAr ? 'ذكاء ' : 'Real Estate Area ',
    titlePart2: isAr ? 'تسعير العقارات' : 'Pricing Intelligence',
    heroDesc: isAr 
    ...
    useCasesList: [
      {
        ...
        title: isAr ? "المستثمرون" : "Investors",
        desc: isAr ? "تحديد العقارات المقومة بأقل من قيمتها والأسواق الناشئة لزيادة عائد الاستثمار." : "Identify undervalued properties and emerging markets to maximize ROI."
      },
      {
        icon: <Home size={32} />,
        title: isAr ? "مدراء العقارات" : "Property Managers",
        desc: isAr ? "تقييم اتجاهات الإيجار الحالية في مناطق مختلفة لتحديد أسعار تنافسية." : "Evaluate current rental trends in different areas to set competitive prices."
      },
      {
        icon: <Building size={32} />,
        title: isAr ? "المطورون" : "Developers",
        desc: isAr ? "تقييم الجدوى المالية للمشاريع الجديدة بناءً على ديناميكيات التسعير المحلية." : "Assess the financial viability of new projects based on local pricing dynamics."
      }
    ],

    detTitle1: isAr ? 'تحليل الاستثمار' : 'Investment Analysis',
    detDesc1: isAr ? 'يستخدم مستثمرو العقارات ذكاء التسعير لتحديد العقارات المقومة بأقل من قيمتها في الأحياء الناشئة، مما يتيح اتخاذ قرارات استثمارية استراتيجية.' : 'Real estate investors use pricing intelligence to identify undervalued properties in emerging neighborhoods, enabling strategic investment decisions.',
    
    detTitle2: isAr ? 'تقييم سوق الإيجار' : 'Rental Market Assessment',
    detDesc2: isAr ? 'يقوم مديرو العقارات بتقييم اتجاهات الإيجار الحالية في مناطق مختلفة لتحديد أسعار تنافسية لعقاراتهم المؤجرة.' : 'Property managers evaluate current rental trends in different areas to set competitive prices for their rental properties.',
    
    detTitle3: isAr ? 'تطوير العقارات التجارية' : 'Commercial Real Estate Development',
    detDesc3: isAr ? 'يقوم المطورون بتقييم اتجاهات التسعير لتحديد مكان بناء مساحات تجارية جديدة، مع التركيز على المناطق ذات قيم العقارات المرتفعة.' : 'Developers assess pricing trends to decide where to build new commercial spaces, focusing on areas with rising property values.',
    ...
    <div className="w-full font-sans text-gray-800 bg-white overflow-hidden" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <section className="py-20 bg-[#fafbfc] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 space-y-32">
          ...
          {/* Row 1: Investment Analysis */}
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left" isAr={isAr}>
                <img 
                  src="/assets/images/png-10.png" 
          ...
          {/* Row 2: Rental Market Assessment */}
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="right" isAr={isAr}>
                <img 
                  src="/assets/images/png-11.png" 
                  alt="Rental Market Assessment" 
                  className="w-full max-w-[500px] mx-auto drop-shadow-2xl hover:scale-105 transition-transform duration-700" 
                />
              </FadeInSection>
            </div>
          ...
          {/* Row 3: Commercial Real Estate Development */}
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left" isAr={isAr}>
                <img 
                  src="/assets/images/png-12.png" 
