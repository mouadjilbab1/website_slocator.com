    ...
    useCasesList: [
      {
        ...
        desc: isAr
          ? 'تحديد العقارات المقومة بأقل من قيمتها والأسواق الناشئة لزيادة عائد الاستثمار.'
          : 'Identify undervalued properties and emerging markets to maximize ROI.',
      },
      {
        icon: <Home size={32} />,
        title: isAr ? 'مدراء العقارات' : 'Property Managers',
        desc: isAr
          ? 'تقييم اتجاهات الإيجار الحالية في مناطق مختلفة لتحديد أسعار تنافسية.'
          : 'Evaluate current rental trends in different areas to set competitive prices.',
      },
      {
        icon: <Building size={32} />,
        title: isAr ? 'المطورون' : 'Developers',
        desc: isAr
          ? 'تقييم الجدوى المالية للمشاريع الجديدة بناءً على ديناميكيات التسعير المحلية.'
          : 'Assess the financial viability of new projects based on local pricing dynamics.',
      },
    ],
