...
import { ArrowRight, CheckCircle2, Building, HeartPulse, Leaf, Quote } from 'lucide-react';
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              <FadeInSection direction="left">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black leading-tight mb-6">
                  Environment <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38e54d] to-[#8eea9e]">Intelligence</span>
                </h1>
            ...
            <div className="lg:w-1/2 relative w-full max-w-lg mx-auto">
              <FadeInSection direction="right" delay={200}>
                <div className="relative">
                  ...
                  <img 
                    src="https://www.s-locator.com/wp-content/uploads/2024/11/png-20.png" 
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <Building size={32} />, title: "Real Estate Development", desc: "Select sites that offer a healthy environment for residents." },
              { icon: <HeartPulse size={32} />, title: "Healthcare", desc: "Plan facilities in areas with low pollution for better patient outcomes." },
              { icon: <Leaf size={32} />, title: "Corporate Responsibility", desc: "Develop sustainability initiatives based on environmental data." }
            ].map((useCase, idx) => (
        ...
        <div className="max-w-7xl mx-auto px-4 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/png-18.png" 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Real Estate Development</h2>
          ...
          {/* Row 2: Public Health Planning */}
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="right">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/png-19.png" 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="left">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Public Health Planning</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
          ...
          {/* Row 3: Corporate Sustainability */}
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left">
                <img 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Corporate Sustainability</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
