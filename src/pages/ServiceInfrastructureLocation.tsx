    ...
    useCasesList: [
      {
        ...
        desc: isAr
          ? 'اختيار مواقع التطوير التي تتمتع بدعم قوي للبنية التحتية.'
          : 'Choose development sites with robust infrastructure support.',
      },
      {
        icon: <Truck size={32} />,
        title: isAr ? 'الخدمات اللوجستية' : 'Logistics',
        desc: isAr
          ? 'تخطيط مراكز التوزيع وسلاسل الإمداد بناءً على شبكات النقل.'
          : 'Plan distribution centers and supply chains based on transportation networks.',
      },
      {
        icon: <Landmark size={32} />,
        title: isAr ? 'الحكومة والقطاع العام' : 'Government',
        desc: isAr
          ? 'تطوير السياسات والمشاريع لتعزيز إمكانية الوصول إلى الخدمات العامة.'
          : 'Develop policies and projects to enhance public service accessibility.',
      },
    ],
