    ...
    useCasesList: [
      {
        ...
        desc: isAr
          ? 'تحديد المواقع المثالية للمتاجر أو الفروع الجديدة من خلال تحليل قرب المنافسين والشركات التكميلية.'
          : 'Identify ideal locations for new stores or branches by analyzing the proximity of competitors and complementary businesses.',
      },
      {
        icon: <Truck size={32} />,
        title: isAr ? 'الخدمات اللوجستية' : 'Logistics',
        desc: isAr
          ? 'تحسين مواقع مراكز التوزيع ومسارات التسليم بناءً على القرب من العملاء والبنية التحتية الحيوية.'
          : 'Optimize distribution center locations and delivery routes based on proximity to clients and critical infrastructure.',
      },
      {
        icon: <ShieldAlert size={32} />,
        title: isAr ? 'خدمات الطوارئ' : 'Emergency Services',
        desc: isAr
          ? 'رسم خرائط للخدمات الأساسية والبنية التحتية للتخطيط الفعال للاستجابة للكوارث.'
          : 'Map essential services and infrastructure for effective disaster response planning.',
      },
    ],
