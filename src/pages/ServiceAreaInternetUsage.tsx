    ...
    useCasesList: [
      {
        ...
        desc: isAr
          ? 'تخطيط توسعات الشبكة وترقيات الخدمة في المناطق ذات الطلب المرتفع.'
          : 'Plan network expansions and service upgrades in high-demand areas.',
      },
      {
        icon: <Users size={32} />,
        title: isAr ? 'الخدمات العامة' : 'Public Services',
        desc: isAr
          ? 'تطوير برامج محو الأمية الرقمية والخدمات الإلكترونية في المناطق منخفضة الاتصال.'
          : 'Develop digital literacy programs and e-services in low-connectivity regions.',
      },
      {
        icon: <MonitorSmartphone size={32} />,
        title: isAr ? 'شركات التكنولوجيا' : 'Tech Companies',
        desc: isAr
          ? 'تحديد الأسواق للمنتجات والخدمات الرقمية بناءً على أنماط الاستخدام.'
          : 'Identify markets for digital products and services based on usage patterns.',
      },
    ],
