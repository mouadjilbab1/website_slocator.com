...
import { ArrowRight, ArrowLeft, CheckCircle2, Radio, Users, MonitorSmartphone, Quote } from 'lucide-react';
...
export default function ServiceAreaInternetUsage() {
  ...
  const t = {
    ...
    titlePart1: isAr ? 'ذكاء ' : 'Area Internet Usage ',
    titlePart2: isAr ? 'استخدام الإنترنت' : 'Intelligence',
    heroDesc: isAr 
    ...
    useCasesList: [
      {
        ...
        desc: isAr ? "تخطيط توسعات الشبكة وترقيات الخدمة في المناطق ذات الطلب المرتفع." : "Plan network expansions and service upgrades in high-demand areas."
      },
      {
        icon: <Users size={32} />,
        title: isAr ? "الخدمات العامة" : "Public Services",
        desc: isAr ? "تطوير برامج محو الأمية الرقمية والخدمات الإلكترونية في المناطق منخفضة الاتصال." : "Develop digital literacy programs and e-services in low-connectivity regions."
      },
      {
        icon: <MonitorSmartphone size={32} />,
        title: isAr ? "شركات التكنولوجيا" : "Tech Companies",
        desc: isAr ? "تحديد الأسواق للمنتجات والخدمات الرقمية بناءً على أنماط الاستخدام." : "Identify markets for digital products and services based on usage patterns."
      }
    ],

    detTitle1: isAr ? 'توسيع شبكات الاتصالات' : 'Telecom Expansion',
    detDesc1: isAr ? 'يحلل مزود الاتصالات أنماط استخدام الإنترنت لتحديد المناطق ذات الاتصال المنخفض، ويخطط لطرح شبكات النطاق العريض أو الهاتف المحمول الجديدة لتلبية الطلب.' : 'A telecom provider analyzes internet usage patterns to identify areas with low connectivity, planning new broadband or mobile network rollouts to meet demand.',
    
    detTitle2: isAr ? 'استراتيجية التجارة الإلكترونية' : 'E-commerce Strategy',
    detDesc2: isAr ? 'يستخدم بائع تجزئة عبر الإنترنت بيانات استخدام الإنترنت لتوجيه جهود التسويق في المناطق ذات المشاركة الرقمية العالية، وتحسين الإنفاق الإعلاني والمبيعات.' : 'An online retailer uses internet usage data to target marketing efforts in areas with high digital engagement, optimizing ad spend and sales efforts.',
    
    detTitle3: isAr ? 'تخطيط السياسات العامة' : 'Public Policy Planning',
    detDesc3: isAr ? 'تستخدم الوكالات الحكومية ذكاء استخدام الإنترنت لتحديد مشكلات الفجوة الرقمية، وتخطيط مبادرات لتحسين محو الأمية الرقمية والوصول في المجتمعات غير المخدومة.' : 'Government agencies use internet usage intelligence to identify digital divide issues, planning initiatives to improve digital literacy and access in underserved communities.',
    ...
    <div className="w-full font-sans text-gray-800 bg-white overflow-hidden" dir={isAr ? 'rtl' : 'ltr'}>
            ...
            <div className="lg:w-1/2 relative w-full max-w-lg mx-auto">
              <FadeInSection direction="right" delay={200} isAr={isAr}>
                <div className="relative">
                  ...
                  {/* استبدال رابط ووردبريس بمسار محلي */}
                  <img 
                    src="/assets/images/png-32.png" 
                    alt="Internet Usage Intelligence Icon" 
      ...
      <section className="py-20 bg-[#fafbfc] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 space-y-32">
          ...
          {/* Row 1: Telecom Expansion */}
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left" isAr={isAr}>
                <img 
                  src="/assets/images/png-30.png" 
                  alt="Telecom Expansion" 
          ...
          {/* Row 2: E-commerce Strategy */}
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="right" isAr={isAr}>
                <img 
                  src="/assets/images/png-31.png" 
          ...
          {/* Row 3: Public Policy Planning */}
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left" isAr={isAr}>
                <img 
                  src="/assets/images/png-32.png" 
                  alt="Public Policy Planning" 
                  className="w-full max-w-[500px] mx-auto drop-shadow-2xl hover:scale-105 transition-transform duration-700" 
                />
              </FadeInSection>
            </div>
