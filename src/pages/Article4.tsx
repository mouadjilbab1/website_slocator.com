...
export default function Article4() {
  ...
  const t = {
    ...
    sec1P2Mid: isAr
      ? ' — وهي منطقة استقطاب محددة يتجاوز فيها طلب المرضى العرض الحالي. توفر '
      : ' — a specific catchment area where patient demand exceeds the current supply. ',
    sec1P2Bold2: isAr ? 'S-LOC' : 'S-LOC (S-Locator)',
    sec1P2End: isAr
      ? ' الحل الجغرافي المكاني الفوري الوحيد لرسم خرائط المنافسين وتوقع الإيرادات قبل توقيع عقد الإيجار.'
      : ' provides the only instant, geospatial solution to map competitors and predict revenue before you sign a lease.',
    ...
    sec2P1Start: isAr
      ...
      : 'The traditional method of “counting pharmacies on a street” is no longer sufficient. You need to understand ',
    sec2P1Bold: isAr ? 'خطر تآكل المبيعات (Cannibalization)' : 'Cannibalization Risk',
    sec2P1End: isAr ? '.' : '.',

    sec2P2Start: isAr
      ? 'إذا فتحت صيدلية على بعد 200 متر من منافس قوي آخر (أو حتى فرعك الحالي)، فإنك تقسم الإيرادات، مما يجعل كلا الفرعين غير مربحين. تقوم '
      : 'If you open a pharmacy within 200 meters of another strong competitor (or even your own existing branch), you split the revenue, making both unprofitable. ',
    sec2P2Bold: isAr ? 'S-LOC' : 'S-LOC',
    sec2P2End: isAr
      ? ' برقمنة هذا التحليل. فهي تستخدم خرائط الأقمار الصناعية لتصور "منطقة الاستقطاب" الدقيقة لموقعك المقترح. وهي تجيب على:'
      : ' digitizes this analysis. It uses satellite mapping to visualize the exact “Catchment Area” of your proposed site. It answers:',
    ...
    sec2List: isAr
      ...
      : [
          { b: 'Patient Density:', t: ' How many residents live within a 5-minute walk?' },
          {
            ...
            t: ' Are the nearby pharmacies major chains or small independents?',
          },
          {
            b: 'Prescription Potential:',
            t: ' Is the site near hospitals or clinics (Polyclinics)?',
          },
        ],

    section3Title: isAr ? 'الدليل (السلطة والثقة)' : 'The Evidence (Authority & Trust)',
    sec3P1: isAr
      ? 'لا يكون تحليل الموقع جيداً إلا بجودة بياناته. تقضي S-LOC على التخمين من خلال المزامنة مع تدفقات البيانات الحكومية الرسمية:'
      : 'A site analysis is only as good as its data. S-LOC eliminates guesswork by syncing with official government streams:',

    sec3List: isAr
      ? [
          {
            b: 'هيئة الإحصاء (التركيبة السكانية):',
            t: ' نحلل كثافة الحي للتأكد من وجود "قوة شرائية" كافية لدعم مبيعات التجميل والمكملات الغذائية ذات الهامش الربحي المرتفع، وليس فقط الوصفات الطبية ذات الهامش المنخفض.',
          },
          {
            b: 'وزارة العدل (المؤشر الإيجاري):',
            t: ' نقوم بمقاطعة سعر إيجار الموقع مع السجل التاريخي لمعاملات وزارة العدل. إذا كان الإيجار مرتفعاً جداً بالنسبة للإيرادات المتوقعة، فإن S-LOC تصنف الموقع على أنه "عالي المخاطر".',
          },
          {
            b: 'الخرائط الحرارية:',
            t: ' تتيح لك رؤية "المناطق الحمراء" (المشبعة) مقابل "المناطق الخضراء" (غير المخدومة) اتخاذ قرارات فورية.',
          },
        ]
      : [
          {
            b: 'GASTAT (Demographics):',
            t: ' We analyze neighborhood density to ensure there is enough “Spending Power” to support high-margin cosmetic and supplement sales, not just low-margin prescriptions.',
          },
          {
            b: 'MOJ (Rental Index):',
            t: ' We cross-reference the site’s rental price with the Ministry of Justice’s transaction history. If the rent is too high for the predicted revenue, S-LOC flags the location as “High Risk.”',
          },
          {
            b: 'Heat Maps:',
            t: ' Visualizing “Red Zones” (Saturated) vs. “Green Zones” (Underserved) allows for instant decision-making.',
          },
        ],
    ...
    <div className="w-full bg-[#fafbfc] font-sans overflow-hidden" dir={isAr ? 'rtl' : 'ltr'}>
      ...
      <section className="max-w-3xl mx-auto px-4 py-20">
        ...
        <div className={`text-gray-700 leading-loose text-lg ${isAr ? 'text-right' : 'text-left'}`}>
          ...
          <p className="mb-6">
            {t.sec1P2Start}
            <strong className="text-[#2b1055] font-black">{t.sec1P2Bold1}</strong>
            {t.sec1P2Mid}
            <strong className="text-[#046bd2]">{t.sec1P2Bold2}</strong>
            {t.sec1P2End}
          </p>
          ...
          <p className="mb-4">
            {t.sec2P1Start}
            <strong className="text-[#110222]">{t.sec2P1Bold}</strong>
            {t.sec2P1End}
          </p>
          <p className="mb-6">
            {t.sec2P2Start}
