    ...
    useCasesList: [
      {
        ...
        desc: isAr
          ? 'تطوير استراتيجيات التسعير وعروض المنتجات بناءً على مستويات الدخل المحلية.'
          : 'Develop pricing strategies and product offerings based on local income levels.',
      },
      {
        icon: <Landmark size={32} />,
        title: isAr ? 'الخدمات المالية' : 'Financial Services',
        desc: isAr
          ? 'تصميم منتجات القروض والرهن العقاري والاستثمار لتناسب فئات الدخل المحددة.'
          : 'Tailor loan, mortgage, and investment products to specific income brackets.',
      },
      {
        icon: <Building2 size={32} />,
        title: isAr ? 'العقارات' : 'Real Estate',
        desc: isAr
          ? 'تحديد المناطق ذات القوة الشرائية العالية لتطوير المشاريع العقارية الفاخرة.'
          : 'Identify areas with high purchasing power for premium property development.',
      },
    ],
