    ...
    useCasesList: [
      {
        ...
        desc: isAr
          ? 'تحديد المناطق عالية الكثافة لافتتاح متاجر جديدة أو تركيز جهود التسويق.'
          : 'Identify high-density areas to open new stores or focus marketing efforts.',
      },
      {
        icon: <Signal size={32} />,
        title: isAr ? 'الاتصالات' : 'Telecommunications',
        desc: isAr
          ? 'تخطيط توسعات الشبكة أو تحسين الخدمات في المناطق المكتظة بالسكان.'
          : 'Plan network expansions or service improvements in densely populated regions.',
      },
      {
        icon: <Building2 size={32} />,
        title: isAr ? 'التخطيط الحضري' : 'Urban Planning',
        desc: isAr
          ? 'تصميم مشاريع البنية التحتية بناءً على احتياجات السكان الحالية والمتوقعة.'
          : 'Design infrastructure projects based on current and projected population needs.',
      },
    ],
