...
import { ArrowRight, CheckCircle2, Store, Signal, Building2, Quote } from 'lucide-react';
            ...
            <div className="lg:w-1/2 text-center lg:text-left">
              <FadeInSection direction="left">
                ...
                <h1 className="text-4xl md:text-5xl lg:text-[56px] font-black leading-tight mb-6">
                  Area <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#38e54d] to-[#8eea9e]">Population Density</span> Intelligence
                </h1>
            ...
            <div className="lg:w-1/2 relative w-full max-w-lg mx-auto">
              <FadeInSection direction="right" delay={200}>
                <div className="relative">
                  ...
                  <img 
                    src="https://www.s-locator.com/wp-content/uploads/2024/10/icons-02-1024x1024.png" 
      ...
      <section className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { icon: <Store size={32} />, title: "Retail", desc: "Identify high-density areas to open new stores or focus marketing efforts." },
              { icon: <Signal size={32} />, title: "Telecommunications", desc: "Plan network expansions or service improvements in densely populated regions." },
              { icon: <Building2 size={32} />, title: "Urban Planning", desc: "Design infrastructure projects based on current and projected population needs." }
            ].map((useCase, idx) => (
      ...
      <section className="py-20 bg-[#fafbfc] overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 space-y-32">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Telecom Network Planning</h2>
          ...
          <div className="flex flex-col lg:flex-row-reverse items-center gap-16">
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="left">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Healthcare Facility Allocation</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="lg:w-1/2 w-full">
              <FadeInSection direction="left">
                <img 
                  src="https://www.s-locator.com/wp-content/uploads/2024/11/icons-22-1024x1024.png" 
            ...
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <FadeInSection direction="right">
                <h2 className="text-[#2b1055] text-3xl md:text-4xl font-black mb-6">Marketing Campaigns</h2>
                <p className="text-gray-600 text-lg leading-relaxed mb-8">
